...
void writeTelnetCommand(TelnetCommand, class Stream&);

void writeTelnetOption(TelnetOption, class Stream&);

void writeTelnetResponse(TelnetCommand, TelnetOption, class Stream&);

const char* telnetCommandToString(TelnetCommand);
